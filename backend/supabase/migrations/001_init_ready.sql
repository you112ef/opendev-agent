...
DROP POLICY IF EXISTS "Users can view own run logs" ON run_logs;
DROP POLICY IF EXISTS "Service role can insert logs" ON run_logs;
DROP POLICY IF EXISTS "Users can view own agent status" ON agent_status;
DROP POLICY IF EXISTS "Service role can update agent status" ON agent_status;
DROP POLICY IF EXISTS "Service role can insert agent status" ON agent_status;
